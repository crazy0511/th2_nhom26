...
public class ProductController {
	...
	public String getAllProducts(Model model) {
		model.addAttribute("products", productRepository.findAllByOrderByDescriptionAsc());
		return "products";
	}
	...
	public String delete(@RequestParam(value = "productCode", required = false) String productCode,
